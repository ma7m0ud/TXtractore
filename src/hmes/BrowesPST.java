 ...
 *
 */
public class BrowesPST implements ActionListener {
...
//                Logger.getLogger(BrowesPST.class.getName()).log(Level.SEVERE, null, ex);
//            } catch (IOException ex) {
//                Logger.getLogger(BrowesPST.class.getName()).log(Level.SEVERE, null, ex);
//            }
//        }
	public BrowesPST(String file) throws PSTException, IOException {
